...
async function getTemplate() {
    let response = await fetch(`https://api.wolfeocrm.com/v1/setting/2/template/52`, {
        ...
        headers: {
            ...
            'authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJMVENCV1M4RkRVTkdTMDNUIiwiaXNzIjoiaHR0cHM6Ly9hcGkuaWxvZ2dlcnouY29tL2FwaS92MS9sb2dpbiIsImlhdCI6MTY3NzY1NTYwMywiZXhwIjoxNjc3NjU5MjAzLCJuYmYiOjE2Nzc2NTU2MDMsImp0aSI6IkxUQ0JXUzhGRFVOR1MwM1QxNjc3NjU1NjAzIn0.WSo2KZqATNkUHuKuesU8I2dxqSHBregbAVk66xv43Vw'
        }
    }).then(async (res) => {
        data = await res.json();
    })
